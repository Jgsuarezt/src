...
(() => {
  ...
  const DICT = {
    en: {
      ...
      step1Title: "Image",
      dropzoneText: "Drag an image or PDF here, or click to choose one",
      step2Title: "Final size",
      fieldWidth: "Width",
      fieldHeight: "Height",
      lockAspect: "Keep the image's aspect ratio",
      step3Title: "Paper",
      fieldPaperSize: "Size",
      paperA4: "A4",
      paperLetter: "Letter",
      ...
      statusPdfLoaded: (w, h) => `PDF loaded (page 1): ${w} × ${h} px`,
      statusPdfError: (msg) => `Could not read the PDF: ${msg}`,
      pdfLibMissing: "Could not load the PDF reader. Check your connection and try again.",
    ...
    es: {
      ...
      step1Title: "Imagen",
      dropzoneText: "Arrastra una imagen o PDF aquí, o haz clic para elegirlo",
      step2Title: "Tamaño final del póster",
      fieldWidth: "Ancho",
      fieldHeight: "Alto",
      lockAspect: "Mantener proporción de la imagen",
      step3Title: "Papel de impresión",
      ...
      statusPdfLoaded: (w, h) => `PDF cargado (página 1): ${w} × ${h} px`,
      statusPdfError: (msg) => `No se pudo leer el PDF: ${msg}`,
      pdfLibMissing: "No se pudo cargar el lector de PDF. Revisa tu conexión e inténtalo de nuevo.",
    ...
    fr: {
      ...
      step1Title: "Image",
      dropzoneText: "Glissez une image ou un PDF ici, ou cliquez pour le choisir",
      step2Title: "Taille finale",
      fieldWidth: "Largeur",
      fieldHeight: "Hauteur",
      lockAspect: "Conserver les proportions de l'image",
      step3Title: "Papier",
      ...
      statusPdfLoaded: (w, h) => `PDF chargé (page 1) : ${w} × ${h} px`,
      statusPdfError: (msg) => `Impossible de lire le PDF : ${msg}`,
      pdfLibMissing: "Impossible de charger le lecteur de PDF. Vérifiez votre connexion et réessayez.",
    ...
    it: {
      ...
      step1Title: "Immagine",
      dropzoneText: "Trascina un'immagine o un PDF qui, o clicca per sceglierlo",
      step2Title: "Dimensione finale",
      fieldWidth: "Larghezza",
      fieldHeight: "Altezza",
      lockAspect: "Mantieni le proporzioni dell'immagine",
      step3Title: "Carta",
      ...
      statusLoadingPdf: "Caricamento PDF…",
      statusPdfLoaded: (w, h) => `PDF caricato (pagina 1): ${w} × ${h} px`,
      statusPdfError: (msg) => `Impossibile leggere il PDF: ${msg}`,
      pdfLibMissing: "Impossibile caricare il lettore PDF. Controlla la connessione e riprova.",
    ...
    pt: {
      ...
      step1Title: "Imagem",
      dropzoneText: "Arraste uma imagem ou PDF aqui, ou clique para escolher",
      step2Title: "Tamanho final",
      fieldWidth: "Largura",
      fieldHeight: "Altura",
      lockAspect: "Manter a proporção da imagem",
      step3Title: "Papel",
      ...
      statusLoadingPdf: "Carregando PDF…",
      statusPdfLoaded: (w, h) => `PDF carregado (página 1): ${w} × ${h} px`,
      statusPdfError: (msg) => `Não foi possível ler o PDF: ${msg}`,
      pdfLibMissing: "Não foi possível carregar o leitor de PDF. Verifique sua conexão e tente novamente.",
    ...
    de: {
      ...
      step1Title: "Bild",
      dropzoneText: "Bild oder PDF hierher ziehen oder klicken zum Auswählen",
      step2Title: "Endgröße",
      fieldWidth: "Breite",
      fieldHeight: "Höhe",
      lockAspect: "Seitenverhältnis des Bildes beibehalten",
      step3Title: "Papier",
      fieldPaperSize: "Format",
      paperA4: "A4",
      paperLetter: "Letter",
      ...
      statusLoadingPdf: "PDF wird geladen…",
      statusPdfLoaded: (w, h) => `PDF geladen (Seite 1): ${w} × ${h} px`,
      statusPdfError: (msg) => `PDF konnte nicht gelesen werden: ${msg}`,
      pdfLibMissing: "PDF-Leser konnte nicht geladen werden. Prüfe deine Verbindung und versuche es erneut.",
    ...
    zh: {
      ...
      step1Title: "图片",
      dropzoneText: "将图片或 PDF 拖到此处，或点击选择",
      step2Title: "成品尺寸",
      fieldWidth: "宽度",
      fieldHeight: "高度",
      lockAspect: "保持图片原始比例",
      ...
      statusLoadingPdf: "正在加载 PDF…",
      statusPdfLoaded: (w, h) => `PDF 已加载（第 1 页）：${w} × ${h} 像素`,
      statusPdfError: (msg) => `无法读取 PDF：${msg}`,
      pdfLibMissing: "无法加载 PDF 阅读器。请检查网络连接后重试。",
