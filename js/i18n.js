...
(() => {
  ...
  const DICT = {
    en: {
      ...
      effectColorHint: "Turns the image into colored dots, keeping the photo's original colors.",
      ...
      fieldPagePosition: "Page position",
      pagePositionHint: "Coordinates on each page.",
    ...
    es: {
      ...
      effectColorHint: "Convierte la imagen en puntos de colores, conservando los colores originales de la foto.",
      ...
      fieldPagePosition: "Posición de página",
      pagePositionHint: "Coordenadas en cada hoja.",
    ...
    fr: {
      ...
      effectColorHint: "Transforme l'image en points colorés, en conservant les couleurs d'origine de la photo.",
      ...
      fieldPagePosition: "Position de la page",
      pagePositionHint: "Coordonnées sur chaque feuille.",
    ...
    it: {
      ...
      effectColorHint: "Trasforma l'immagine in punti colorati, mantenendo i colori originali della foto.",
      ...
      fieldPagePosition: "Posizione pagina",
      pagePositionHint: "Coordinate su ogni foglio.",
    ...
    pt: {
      ...
      effectColorHint: "Transforma a imagem em pontos coloridos, mantendo as cores originais da foto.",
      ...
      fieldPagePosition: "Posição da página",
      pagePositionHint: "Coordenadas em cada folha.",
    ...
    de: {
      ...
      effectColorHint: "Verwandelt das Bild in farbige Punkte und behält die Originalfarben des Fotos bei.",
      ...
      fieldPagePosition: "Seitenposition",
      pagePositionHint: "Koordinaten auf jedem Blatt.",
    ...
    zh: {
      ...
      effectColor: "彩色网点",
      effectColorHint: "把图片变成彩色网点，保留照片原本的颜色。",
      fieldDotSize: "网点大小",
      dotQualityHigh: "质量更高",
      dotQualityLow: "质量更低",
      step5Title: "质量",
      ...
      fieldPagePosition: "页面位置",
      pagePositionHint: "每张纸上的坐标。",
      generateBtn: "生成海报",
  ...
  function paintStaticText() {
    ...
    const optEffectColor = document.getElementById("opt-effectColor");
    if (optEffectColor) optEffectColor.title = t("effectColorHint");
